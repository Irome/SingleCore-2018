...
void ObjectMgr::LoadCreatureTemplates()
{
	...
	// EJ init trainers
	mTradeSkillTrainersEntryStore.clear();
	mClassSpellTrainersEntryStore.clear();
	...
	do
	{
		...
		// EJ init trainer store
		if (creatureTemplate.trainer_type == TRAINER_TYPE_TRADESKILLS)
		{
			mTradeSkillTrainersEntryStore.insert(creatureTemplate.Entry);
		}
		else if (creatureTemplate.trainer_type == TRAINER_TYPE_CLASS)
		{
			mClassSpellTrainersEntryStore[creatureTemplate.trainer_class].insert(creatureTemplate.Entry);
		}
