...
string ChatHelper::formatItem(ItemTemplate const * proto, int count, int total)
{
    char color[32];
...
list<uint64> ChatHelper::parseGameobjects(string& text)
{
    list<uint64> gos;
    //    Link format
    ...
    while (true)
    {
        ...
        uint64 lootCurrent = uint64(guid);
